...
export default function Loading() {
  return (
    <div className="min-h-[60vh] flex items-center justify-center relative overflow-hidden">
      ...
      <div className="absolute inset-0 bg-gradient-to-br from-primary-950/50 via-accent-950/20 to-primary-900/50"></div>
      ...
      <div className="relative z-10 text-center px-4 sm:px-6">
        ...
        <div className="flex justify-center items-center gap-1 sm:gap-2 text-primary-200 text-base sm:text-lg">
          <span className="animate-pulse delay-100">Preparing</span>
        ...
        <div className="mt-12 sm:mt-14 md:mt-16 flex flex-wrap justify-center gap-4 sm:gap-6 md:gap-8 text-primary-300 text-xs sm:text-sm opacity-70 px-4">
          <div className="flex items-center gap-1.5 sm:gap-2">
            ...
            <span className="whitespace-nowrap">Mountain Retreats</span>
          </div>
          <div className="flex items-center gap-1.5 sm:gap-2">
            <span className="text-accent-400 text-sm sm:text-base">✦</span>
            <span className="whitespace-nowrap">5-Star Experience</span>
          </div>
        </div>
      </div>
    </div>
